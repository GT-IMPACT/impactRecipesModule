    ...
    private void handRecipe() {
        ...
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("BuildCraft|Builders", "fillerBlock", 1L, 0),
                        tBitMask, new Object[]{"PMP", "CHC", "GIG", 'P', ItemList.Electric_Piston_MV, 'M',
                                GT_ModHandler.getModItem("BuildCraft|Core", "markerBlock", 1L, 0), 'C',
                                ItemList.Conveyor_Module_MV, 'H', ItemList.MACHINE_HULLS[2], 'G',
                                GT_OreDictUnificator.get(OrePrefixes.gearGt, Materials.Gold, 1), 'I',
                                GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 1)});
        // --- Builder
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("BuildCraft|Builders", "builderBlock", 1L, 0),
                        tBitMask, new Object[]{"PMP", "CHC", "GIG", 'P', ItemList.Robot_Arm_MV, 'M',
                                GT_ModHandler.getModItem("BuildCraft|Core", "markerBlock", 1L, 0), 'C',
                                ItemList.Conveyor_Module_MV, 'H', ItemList.MACHINE_HULLS[2], 'G',
                                GT_OreDictUnificator.get(OrePrefixes.gearGt, Materials.Birmabright, 1), 'I',
                                GT_ModHandler.getModItem("chestup", "Blockchestup", 1L, 1)});
        // --- Architect
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("BuildCraft|Builders", "architectBlock", 1L, 0),
                        tBitMask, new Object[]{"PMP", "CHC", "GIG", 'P', ItemList.Robot_Arm_MV, 'M',
                                GT_ModHandler.getModItem("BuildCraft|Core", "markerBlock", 1L, 0), 'C',
                                ItemList.Conveyor_Module_MV, 'H', ItemList.MACHINE_HULLS[2], 'G',
                                GT_OreDictUnificator.get(OrePrefixes.gearGt, Materials.Birmabright, 1), 'I',
        ...
        // --- Library
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("BuildCraft|Builders", "libraryBlock", 1L, 0),
                        tBitMask,
                        new Object[]{"PGP", "CHC", "PIP", 'P', OrePrefixes.plate.get(Materials.Iron), 'C',
                                OrePrefixes.circuit.get(Materials.Basic), 'H', ItemList.MACHINE_HULLS[2], 'G',
                                GT_OreDictUnificator.get(OrePrefixes.gearGt, Materials.Birmabright, 1), 'I',
                                ItemList.Cover_Screen});
        // --- Marker Blue
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("BuildCraft|Core", "markerBlock", 1L, 0),
                        tBitMask, new Object[]{" S ", " L ", 'L', OrePrefixes.stick.get(Materials.Wood), 'S',
                                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Lapis, 1)});
        // --- Marker Yellow
        GT_ModHandler.addCraftingRecipe(
                GT_ModHandler.getModItem("BuildCraft|Core", "constructionMarkerBlock", 1L, 0), tBitMask,
                new Object[]{" S ", " L ", 'L', OrePrefixes.stick.get(Materials.Wood), 'S',
                        getStackofAmountFromOreDict("dyeYellow", 1)});
        // --- Marker Green
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("BuildCraft|Core", "pathMarkerBlock", 1L, 0),
                        tBitMask, new Object[]{" S ", " L ", 'L', OrePrefixes.stick.get(Materials.Wood), 'S',
                                getStackofAmountFromOreDict("dyeGreen", 1)});
        // --- BluePrint
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("BuildCraft|Builders", "blueprintItem", 1L, 0),
                        tBitMask, new Object[]{"LS", 'L', OrePrefixes.plate.get(Materials.Paper), 'S',
                                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Lapis, 1)});
        // --- BlackPrint
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("BuildCraft|Builders", "templateItem", 1L, 0),
                        tBitMask, new Object[]{"LS", 'L', OrePrefixes.plate.get(Materials.Paper), 'S',
                                getStackofAmountFromOreDict("dyeBlack", 1)});
        // --- Redstone Engine
        GT_ModHandler
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler
                ...
                new Object[]{" f ", "SGS", " s ", 'S', OrePrefixes.stick.get(Materials.Wood), 'G',
                        GT_ModHandler.getModItem("minecraft", "glass_pane", 1L)});
        // --- Cobblestone Pipe
        GT_ModHandler.addCraftingRecipe(GT_ModHandler
                        .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipeitemscobblestone", 1L, 0),
                tBitMask,
                new Object[]{" f ", "SGS", " s ", 'S', CoreItems2.getRecipe(CobblestoneRod.getMetaID(), 1),
        ...
        // --- Quartz Pipe
        GT_ModHandler.addCraftingRecipe(GT_ModHandler
                        .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipeitemsquartz", 1L, 0), tBitMask,
                new Object[]{" f ", "SGS", " s ", 'S', OrePrefixes.stick.get(Materials.NetherQuartz), 'G',
                        GT_ModHandler.getModItem("minecraft", "glass_pane", 1L)});
        // --- Sandstone Pipe
        GT_ModHandler.addCraftingRecipe(GT_ModHandler
                        .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipeitemssandstone", 1L, 0),
                tBitMask,
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler
                ...
                new Object[]{"SGS", "GOG", "SGS", 'S', OrePrefixes.stick.get(Materials.Obsidian), 'G',
                        GT_ModHandler.getModItem("minecraft", "glass_pane", 1L), 'O',
                        GT_ModHandler.getModItem("ExtraUtilities", "trashcan", 1L)});
        // --- Void Fluid Pipe
        GT_ModHandler.addCraftingRecipe(GT_ModHandler
                        .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipefluidsvoid", 1L, 0), tBitMask,
                new Object[]{"SGS", "GOG", "SGS", 'S', OrePrefixes.stick.get(Materials.Rubber), 'G',
                        GT_ModHandler.getModItem("minecraft", "glass_pane", 1L), 'O',
                        GT_ModHandler.getModItem("ExtraUtilities", "trashcan", 1L)});
        ...
        for (int i = 0; i < 16; i++) {
            ...
            GT_ModHandler.addCraftingRecipe(GT_ModHandler
                            .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipeitemswood", 1L, i + 1),
                    tBitMask,
                    new Object[]{" f ", "SGS", " s ", 'S', OrePrefixes.stick.get(Materials.Wood), 'G',
            ...
            GT_ModHandler.addCraftingRecipe(GT_ModHandler
                    .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipeitemscobblestone", 1L,
                            i + 1), tBitMask, new Object[]{" f ", "SGS", " s ", 'S',
                    CoreItems2.getRecipe(CobblestoneRod.getMetaID(), 1), 'G',
                    new ItemStack(Blocks.stained_glass_pane, 1, i)});
            // --- Stone Pipe (Colorfull)
            GT_ModHandler.addCraftingRecipe(GT_ModHandler
                            .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipeitemsstone", 1L, i + 1),
                    tBitMask,
                    new Object[]{" f ", "SGS", " s ", 'S', OrePrefixes.stick.get(Materials.Stone), 'G',
                            new ItemStack(Blocks.stained_glass_pane, 1, i)});
            // --- Quartz Pipe (Colorfull)
            GT_ModHandler.addCraftingRecipe(GT_ModHandler
                            .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipeitemsquartz", 1L, i + 1),
                    tBitMask,
                    new Object[]{" f ", "SGS", " s ", 'S', OrePrefixes.stick.get(Materials.NetherQuartz), 'G',
                            new ItemStack(Blocks.stained_glass_pane, 1, i)});
            // --- Sandstone Pipe (Colorfull)
            GT_ModHandler.addCraftingRecipe(GT_ModHandler
                            .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipeitemssandstone", 1L, i + 1),
                    tBitMask,
                    new Object[]{" f ", "SGS", " s ", 'S', CoreItems2.getRecipe(SandstoneRod.getMetaID(), 1),
            ...
            // --- Void Fluid Pipe
            GT_ModHandler.addCraftingRecipe(GT_ModHandler
                            .getModItem("BuildCraft|Transport", "item.buildcraftPipe.pipefluidsvoid", 1L, i + 1),
                    tBitMask,
                    new Object[]{"SGS", "GOG", "SGS", 'S', OrePrefixes.stick.get(Materials.Rubber), 'G',
                            new ItemStack(Blocks.stained_glass_pane, 1, i), 'O',
                            GT_ModHandler.getModItem("ExtraUtilities", "trashcan", 1L)});
