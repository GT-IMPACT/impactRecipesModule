...
//Fusion Casing MK1
    ...
    private void mixer() {
        ...
        RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone, 2L),
                ...
                Materials.Concrete.getMolten(1152L), GT_Values.NI, 40, 12);
        RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone, 2L),
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Gypsum, 1L),
		...
		RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 1L),
                ...
                GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DarkAsh, 2L), 200, 7);
    ...
    private void ebf() {
        ...
        RA.addBlastRecipe(
                ...
                GT_Utility.getIntegratedCircuit(11), Materials.Argon.getGas(1000L), GT_Values.NF,
                GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.ElectrumFlux, 1L),
                GT_Values.NI, 1000, 122880, 9000);
        RA.addBlastRecipe(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.ElectrumFlux, 1L),
                GT_Utility.getIntegratedCircuit(12), Materials.PerroxGas.getGas(20L), GT_Values.NF,
                GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.ElectrumFlux, 1L),
                GT_Values.NI, 250, 122880, 9000);
        RA.addBlastRecipe(
        ...
        RA.addBlastRecipe(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NaquadahAlloy, 1L),
                GT_Utility.getIntegratedCircuit(12), Materials.Perrox.getGas(20L), GT_Values.NF,
                GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NaquadahAlloy, 1L),
                GT_Values.NI, 40, 122880, 7200);	    
        RA.addBlastRecipe(
        ...
        RA.addBlastRecipe(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadria, 1L),
                GT_Utility.getIntegratedCircuit(10), Materials.Perrox.getGas(20L), GT_Values.NF,
                GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Naquadria, 1L), GT_Values.NI, 50,
                122880, 9000);
        RA.addBlastRecipe(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Osmiridium, 1L),
    ...
    private void cuttingSaw() {
        ...
        RA.addCutterRecipe(ItemList.Circuit_Silicon_Ingot.get(1),
                ItemList.Circuit_Silicon_Wafer.get(16), null, 400, 12);
    ...
    private void ciruit() {
             // --- GT Circuits
                ...
                RA.addCircuitAssemblerRecipe(
                        ...
                        GT_ModHandler.getModItem("IC2", "itemPartCircuit", 2L, 0), 200, 12);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1),
                ...
                RA.addCircuitAssemblerRecipe(
                        ...
                        Materials.SolderingAlloy.getMolten(72L), ItemList.Circuit_Basic.get(3), 200, 12);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1),
                ...
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Plastic_Advanced.get(1),
                                ItemList.Circuit_Processor.get(2), ItemList.Circuit_Parts_InductorSMD.get(4),
                ...
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Epoxy_Advanced.get(1),
                                ItemList.Circuit_Nanoprocessor.get(2), ItemList.Circuit_Parts_InductorSMD.get(8),
                ...
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium, 2),
                                ItemList.Circuit_Data.get(2), ItemList.Circuit_Parts_InductorSMD.get(6),
                ...
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium, 2),
                                ItemList.Circuit_Data.get(2), ItemList.Circuit_Parts_InductorASMD.get(3L),
                ...
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Fiberglass_Advanced.get(1),
                                ItemList.Circuit_Quantumprocessor.get(2), ItemList.Circuit_Parts_InductorSMD.get(12),
                ...
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium, 2),
                                ItemList.Circuit_Elitenanocomputer.get(2), ItemList.Circuit_Parts_InductorSMD.get(16),
                ...
                RA.addCircuitAssemblerSpaceRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Multifiberglass_Elite.get(1L),
                                ItemList.Circuit_Crystalprocessor.get(2L), ItemList.Circuit_Parts_InductorASMD.get(8),
                ...
                RA.addCircuitAssemblerSpaceRecipe(
                        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium, 2),
                                ItemList.Circuit_Masterquantumcomputer.get(2), ItemList.Circuit_Parts_InductorSMD.get(32),
                ...
                RA.addCircuitAssemblerSpaceRecipe(
                        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium, 2),
                                ItemList.Circuit_Masterquantumcomputer.get(2L), ItemList.Circuit_Parts_InductorASMD.get(8),
                ...
                RA.addCircuitAssemblerSpaceRecipe(
                        new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium, 2),
                                ...
                                ItemList.Circuit_Parts_InductorASMD.get(8L), ItemList.Circuit_Parts_CapacitorASMD.get(16L),
                ...
                RA.addCircuitAssemblerSpaceRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Bio_Ultra.get(1L),
                                ItemList.Circuit_Bioprocessor.get(2L), ItemList.Circuit_Parts_InductorASMD.get(12L),
...
//Motors
    ...
    private void canner() {
        ...
        RA.addCannerRecipe(ItemList.Large_Fluid_Cell_TungstenSteel.get(1L),
                ...
                ItemList.NaquadahCell_1.get(1L), null, 30, 12);
        RA.addCannerRecipe(ItemList.Large_Fluid_Cell_TungstenSteel.get(1L),
                Itemstack(Core_Items2.getInstance(), 1, 186),
                ItemList.MNqCell_1.get(1L), null, 30, 12);

        RA.addCannerRecipe(GT_ModHandler.getIC2Item("fuelRod", 1),
                CoreItems2.getRecipe(188, 1),
                ItemList.ThoriumCell_1.get(1L), null, 30, 12);
        RA.addCannerRecipe(GT_ModHandler.getIC2Item("fuelRod", 1),
                CoreItems2.getRecipe(189, 1),
                ItemList.MThCell_1.get(1L), null, 30, 12);
