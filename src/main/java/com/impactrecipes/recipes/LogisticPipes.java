...
public class LogisticPipes implements Runnable {
    ...
    private void removeLP() {
        ...
        removeRecipeByOutput(
                ...
                false, false);
        for (int i = 0; i < 17; i++) {
            removeRecipeByOutput(GT_ModHandler.getModItem("LogisticsPipes", "item.remoteOrdererItem", 1L, i),
                    true, false, false);
        }
    ...
    private void assembler() {
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                ...
                GT_Utility.getIntegratedCircuit(8)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicTransport", 16L, 0), 120, 48);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                ...
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicLogistics", 1L, 0), 100, 120);
        RA.addAssemblerRecipe(new ItemStack[]{
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicTransport", 4L, 0),
                GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Aluminium, 1L),
                GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicLogistics", 4L, 0), 120, 120);
        RA.addAssemblerRecipe(new ItemStack[]{
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicTransport", 16L, 0),
                GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.PolyvinylChloride, 1L),
                GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicLogistics", 16L, 0), 140, 120);
        RA.addAssemblerRecipe(new ItemStack[]{
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicTransport", 64L, 0),
                GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Platinum, 1L),
                GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicLogistics", 64L, 0), 160, 120);
        // --- Logistics Chassis Mk1
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsBasicLogistics", 4L, 0),
                ...
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk1", 4L, 0), 200, 30);
        // --- Logistics Chassis Mk2
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk1", 4L, 0),
                ...
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk2", 4L, 0), 200, 30);
        // --- Logistics Chassis Mk3
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk2", 4L, 0),
                ...
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk3", 4L, 0), 200, 48);
        // --- Logistics Chassis Mk4
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk3", 4L, 0),
                ...
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk4", 4L, 0), 200, 86);
        // --- Logistics Chassis Mk5
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk4", 4L, 0),
                ...
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk5", 4L, 0), 200, 120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 1L),
                        GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsCraftingLogistics", 4L, 0),
                100, 120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 1L),
                        GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsCraftingLogisticsMk2", 4L, 0),
                120, 120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 1L),
                        GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsCraftingLogisticsMk3", 4L, 0),
                140, 120);
        // --- Provider Logistics Pipe
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk1", 4L, 0),
                        ItemList.Conveyor_Module_LV.get(1), GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsProviderLogistics", 4L, 0), 100,
                120);
        // --- Provider Logistics Pipe Mk2
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeLogisticsChassiMk2", 4L, 0),
                        ItemList.Conveyor_Module_MV.get(1), GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsProviderLogisticsMk2", 4L, 0),
                120, 120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                ...
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsSupplierLogistics", 4L, 0), 100,
                120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                        ...
                        GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsRequestLogistics", 4L, 0), 100,
                120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                        ...
                        GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsRequestLogisticsMk2", 4L, 0), 100,
                120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                        ...
                        GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsInvSysConnector", 4L, 0), 100,
                120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                        ...
                        GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsFirewall", 4L, 0), 120, 120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                ...
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsSystemEntranceLogistics", 4L, 0),
                120, 120);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{
                ...
                Materials.RedAlloy.getMolten(288), GT_ModHandler
                        .getModItem("LogisticsPipes", "item.PipeItemsSystemDestinationLogistics", 4L, 0), 120,
                120);
        // --- Satellite Logistics Pipe
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsCraftingLogistics", 4L, 0),
                        ItemList.Electric_Piston_MV.get(1), GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsSatelliteLogistics", 4L, 0), 100,
                120);
        // --- Remote Ordered Logistics Pipe
        RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsSystemEntranceLogistics", 4L, 0),
                        ItemList.Conveyor_Module_MV.get(1), GT_Utility.getIntegratedCircuit(1)}, null,
                GT_ModHandler.getModItem("LogisticsPipes", "item.PipeItemsRemoteOrdererLogistics", 4L, 0),
                120, 120);
        // --- Blank Module
    ...
    private void ciruit() {
                ...
                RA.addCircuitAssemblerRecipe(
                        ...
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 6), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 2)},
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 7), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 2)},
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 20), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 2)},
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 16), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 2)},
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 21), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                        ...
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 23), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Gold, 1),
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Electrum, 2)},
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 24), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Steel, 1),
                        ...
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 25), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Steel, 1),
                        ...
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 30), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 2)},
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 41), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 2)},
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 42), 120, 30);
                RA.addCircuitAssemblerRecipe(
                        new ItemStack[]{ItemList.Circuit_Board_Coated_Basic.get(1L),
                                ItemList.Circuit_Chip_Simple_SoC.get(1L),
                                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.RedAlloy, 1),
                        ...
                        Materials.SolderingAlloy.getMolten(72L),
                        GT_ModHandler.getModItem("LogisticsPipes", "item.itemUpgrade", 2L, 26), 120, 30);
    }

    private void chemicalBathRecipe() {
        for (int i = 0; i < 16; i++) {
            for (int j = 0; j < Dyes.VALUES[i].getSizeOfFluidList(); j++) {
                RA.addChemicalBathRecipe(GT_ModHandler.getModItem("LogisticsPipes", "item.remoteOrdererItem", 1L, 0), Dyes.VALUES[i].getFluidDye(j, 36L), GT_ModHandler.getModItem("LogisticsPipes", "item.remoteOrdererItem", 1L, 1 + i), GT_Values.NI, GT_Values.NI, null, 20, 2);
                }
            RA.addChemicalBathRecipe(GT_ModHandler.getModItem("LogisticsPipes", "item.remoteOrdererItem", 1L, 1 + i), Materials.Chlorine.getGas(50L), GT_ModHandler.getModItem("LogisticsPipes", "item.remoteOrdererItem", 1L, 0), GT_Values.NI, GT_Values.NI, null, 20, 2);
        }
    }
}
