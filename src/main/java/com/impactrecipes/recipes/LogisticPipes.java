...
public class LogisticPipes implements Runnable {
    ...
    private void hand() {
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(LP, "logisticsSolidBlock", 1L, 4), tBitMask, new Object[]{"RMR", "OCB", "IGI", 'G', OrePrefixes.gearGtSmall.get(Materials.Steel), 'M', GT_ModHandler.getModItem("BuildCraft|Factory", "autoWorkbenchBlock", 1L, 0), 'R', OrePrefixes.plate.get(Materials.Lapis), 'P', OrePrefixes.plate.get(Materials.Steel), 'M', ItemList.Electric_Motor_LV, 'C', ItemList.Casing_LV});
