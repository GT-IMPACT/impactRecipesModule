...
public class UBC implements Runnable {
    ...
    private void cuttingSaw() {
        for (int i = 0; i < 8; i++) {
            // --- Slabs
            GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "igneousStoneBrick", 1L, i),
                    GT_ModHandler.getModItem("UndergroundBiomes", "igneousStoneBrickHalfSlab", 2L, i), GT_Values.NI, 25, 8);
            GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "metamorphicStoneBrick", 1L, i),
                    GT_ModHandler.getModItem("UndergroundBiomes", "metamorphicStoneBrickHalfSlab", 2L, i), GT_Values.NI, 25, 8);
            GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "igneousStone", 1L, i),
                    GT_ModHandler.getModItem("UndergroundBiomes", "igneousStoneHalfSlab", 2L, i), GT_Values.NI, 25, 8);
            GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "metamorphicStone", 1L, i),
                    GT_ModHandler.getModItem("UndergroundBiomes", "metamorphicStoneHalfSlab", 2L, i), GT_Values.NI, 25, 8);
            GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "igneousCobblestone", 1L, i),
                    GT_ModHandler.getModItem("UndergroundBiomes", "igneousCobblestoneHalfSlab", 2L, i), GT_Values.NI, 25, 8);
            GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "metamorphicCobblestone", 1L, i),
                    GT_ModHandler.getModItem("UndergroundBiomes", "metamorphicCobblestoneHalfSlab", 2L, i), GT_Values.NI, 25, 8);
            GT_Values.RA.addCutterRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "sedimentaryStone", 1L, i),
    ...
    private void pulverizer() {
        // --- Limestone
        GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "sedimentaryStone", 1L, 0),
        ...
        // --- Chalk
        GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "sedimentaryStone", 1L, 1),
                new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dustImpure, Materials.Calcite, 1),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Siltstone, 1)},
                new int[]{10000, 100}, 400, 2);
        // --- Shale
        GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "sedimentaryStone", 1L, 2),
                new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dustImpure, Materials.Calcite, 1),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.VanadiumMagnetite, 1)},
                new int[]{10000, 100}, 400, 2);
        // --- Siltstone
        GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "sedimentaryStone", 1L, 3),
                ...
                new int[]{10000, 100}, 400, 2);
        // --- Dolomite
        GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "sedimentaryStone", 1L, 5),
                ...
                new int[]{10000, 100}, 400, 2);
        // --- Greywacke
        GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "sedimentaryStone", 1L, 6),
                ...
                new int[]{10000, 100}, 400, 2);
        // --- Chert
        GT_Values.RA.addPulveriserRecipe(GT_ModHandler.getModItem("UndergroundBiomes", "sedimentaryStone", 1L, 7),
