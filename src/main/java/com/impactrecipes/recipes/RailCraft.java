...
public class RailCraft implements Runnable {
    ...
    private void handRecipe() {
        ...
        GT_ModHandler.addCraftingRecipe(ModRenderType.DIESEL
                .getItemWithRenderer("railcraft:default", ModEnumCart.LOCO_DIESEL.getCartItem()), recipe);
        // --- Wheels
        recipe = new Object[]{
                " h ", "RSR", " w ",
        ...
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("Railcraft", "armor.goggles", 1L), recipe);
        // --- Magnifying Glass
        recipe = new Object[]{
                "  L", " R ", "S  ",
                'L', OrePrefixes.lens.get(Materials.Glass),
        ...
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("Railcraft", "tool.magnifying.glass", 1L),
                        recipe);
        ...
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("Railcraft", "upgrade.lapotron", 1L), recipe);
        // --- Borehead Iron
        recipe = new Object[]{
                "GPG", "PBP", "GPG",
                'B', OrePrefixes.block.get(Materials.Iron),
        ...
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("Railcraft", "borehead.iron", 1L), recipe);
        // --- Borehead Steel
        recipe = new Object[]{
                "GPG", "PBP", "GPG",
                'B', OrePrefixes.block.get(Materials.Steel),
        ...
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("Railcraft", "borehead.steel", 1L), recipe);
        // --- Borehead Diamond
        recipe = new Object[]{
                "DD ",
        ...
        GT_ModHandler
                .addCraftingRecipe(GT_ModHandler.getModItem("Railcraft", "borehead.diamond", 1L), recipe);
        ...
        GT_ModHandler
                .addCraftingRecipe(RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD), recipe);
        recipe = new Object[]{
                " I ", "hIf", " I ",
                'I', OrePrefixes.stickLong.get(Materials.WroughtIron)
        };
        GT_ModHandler
                .addCraftingRecipe(RailcraftItem.rail.getStack(5, ItemRail.EnumRail.STANDARD), recipe);
        recipe = new Object[]{
                " I ", "hIf", " I ",
                'I', OrePrefixes.stickLong.get(Materials.Steel)
        };
        GT_ModHandler
                .addCraftingRecipe(RailcraftItem.rail.getStack(8, ItemRail.EnumRail.STANDARD), recipe);
        // --- Advanced Rail
        recipe = new Object[]{
                " I ", "hIf", " I ",
        ...
        GT_ModHandler
                .addCraftingRecipe(RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED), recipe);
        // --- Electric Rail
        recipe = new Object[]{
                " I ", "hIf", " I ",
        ...
        GT_ModHandler
                .addCraftingRecipe(RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ELECTRIC), recipe);
        // --- Reinforced Rail
        recipe = new Object[]{
                " I ", "hIf", " I ",
        ...
        GT_ModHandler
                .addCraftingRecipe(RailcraftItem.rail.getStack(6, ItemRail.EnumRail.REINFORCED), recipe);
        // --- H.S. Rail
        recipe = new Object[]{
                " I ", "hIf", " I ",
        ...
        GT_ModHandler
                .addCraftingRecipe(RailcraftItem.rail.getStack(6, ItemRail.EnumRail.SPEED), recipe);
        ...
        GT_ModHandler.addCraftingRecipe(
                GT_ModHandler.getModItem("computronics", "computronics.digitalControllerBox", 1L), recipe);
        ...
        GT_ModHandler.addCraftingRecipe(
                GT_ModHandler.getModItem("computronics", "computronics.digitalReceiverBox", 1L), recipe);
        ...
        GT_ModHandler.addCraftingRecipe(
                GT_ModHandler.getModItem("computronics", "computronics.locomotiveRelay", 1L), recipe);
    ...
    private void assemblerRecipe() {
        ...
        GT_Values.RA
                .addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.BlueSteel, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.ring, Materials.BlueSteel, 2L),
                        new ItemStack(Objects.metaItem, 1, 0), 300, 2);
        // --- Cart
        GT_Values.RA
        ...
        // --- Stone Tie
        GT_Values.RA
                .addAssemblerRecipe(new ItemStack(Blocks.stone_slab, 3, 0), RailcraftItem.rebar.getStack(1),
    ...
    private void benderRecipe() {
        ...
        GT_Values.RA
                .addBenderRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 12L),
                        RailcraftItem.rebar.getStack(24), 1200, 15);
        GT_Values.RA
                .addBenderRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Titanium, 12L),
                        RailcraftItem.rebar.getStack(32), 1600, 15);
        GT_Values.RA
    ...
    private void chemicalBathRecipe() {
        ...
        // --- Concrete Tie
        GT_Values.RA
                .addChemicalBathRecipe(RailcraftItem.rebar.getStack(1), Materials.Concrete.getMolten(72L),
        ...
        for (Materials tMat : Materials.values()) {
            if (tMat.mStandardMoltenFluid != null && tMat.contains(SubTag.SOLDERING_MATERIAL) && !(
                ...
                RA.addCircuitAssemblerRecipe(
                        ...
                        new ItemStack(Objects.ocComponents, 1, 0), 300, 120);
            }
        }
    }
    ...
    private void extruderRecipe() {
        ...
        RA.addExtruderRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 3L),
                ...
                120, 24);
        GT_Values.RA
                .addExtruderRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron, 3L),
                        CoreItems2.getRecipe(166, 0),
                        RailcraftItem.rail.getStack(5, ItemRail.EnumRail.STANDARD), 130, 24);
        GT_Values.RA
        ...
        RA.addExtruderRecipe(
                ...
                200, 24);
        GT_Values.RA
                .addExtruderRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Titanium, 3L),
                        CoreItems2.getRecipe(166, 0),
                        RailcraftItem.rail.getStack(16, ItemRail.EnumRail.STANDARD), 240, 24);
        GT_Values.RA
                .addExtruderRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.TungstenSteel, 3L),
                        CoreItems2.getRecipe(166, 0),
                        RailcraftItem.rail.getStack(20, ItemRail.EnumRail.STANDARD), 280, 24);
        GT_Values.RA
                .addExtruderRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iridium, 3L),
                        CoreItems2.getRecipe(166, 0),
    ...
    private void trackAssemblerRecipe() {
        ...
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1),
                        ...
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.WOOD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)}, EnumTrack.SLOW.getItem(8),
                200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.WOOD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.SLOW.getItem(16), 400, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(1), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.WOOD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.SLOW.getItem(32), 600, 12);
        // --- Wooden Booster Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                ...
                EnumTrack.SLOW_BOOSTER.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.SLOW_BOOSTER.getItem(8), 400, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(5), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.SLOW_BOOSTER.getItem(16), 600, 12);
        // --- Wooden Switch
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(10), EnumTrack.SLOW.getItem(1),
                        RailcraftItem.rail.getStack(1, ItemRail.EnumRail.WOOD),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Iron, 1L)},
                EnumTrack.SLOW_SWITCH.getItem(2), 200, 6);
        // --- Wooden WYE
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(15), EnumTrack.SLOW.getItem(1),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.WOOD),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Iron, 1L)},
                EnumTrack.SLOW_WYE.getItem(2), 200, 6);
        // --- Wooden Junction
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(20),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.WOOD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.SLOW_JUNCTION.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(20),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(8, ItemRail.EnumRail.WOOD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.SLOW_JUNCTION.getItem(8), 400, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(20), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(10, ItemRail.EnumRail.WOOD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.SLOW_JUNCTION.getItem(16), 600, 12);

        // --- Reinforced Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.REINFORCED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Birmabright, 2L)},
                EnumTrack.REINFORCED.getItem(8), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(1), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.REINFORCED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.StainlessSteel, 2L)},
                EnumTrack.REINFORCED.getItem(20), 300, 8);
        // --- Reinforced Booster Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.REINFORCED),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Birmabright, 2L)},
                EnumTrack.REINFORCED_BOOSTER.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(5), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.REINFORCED),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.StainlessSteel, 2L)},
                EnumTrack.REINFORCED_BOOSTER.getItem(10), 300, 8);
        // --- Reinforced Switch
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(10), EnumTrack.REINFORCED.getItem(1),
                        RailcraftItem.rail.getStack(1, ItemRail.EnumRail.REINFORCED),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Birmabright, 1L)},
                EnumTrack.REINFORCED_SWITCH.getItem(2), 200, 6);
        // --- Reinforced WYE
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(15), EnumTrack.REINFORCED.getItem(1),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.REINFORCED),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Birmabright, 1L)},
                EnumTrack.REINFORCED_WYE.getItem(2), 200, 6);
        // --- Reinforced Junction
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(20),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.REINFORCED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Birmabright, 2L)},
                EnumTrack.REINFORCED_JUNCTION.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(20), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(8, ItemRail.EnumRail.REINFORCED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.StainlessSteel, 2L)},
                EnumTrack.REINFORCED_JUNCTION.getItem(10), 300, 8);

        // --- Electric Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.ELECTRIC),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Copper, 2L)},
                EnumTrack.ELECTRIC.getItem(8), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(1), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ELECTRIC),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.AnnealedCopper, 2L)},
                EnumTrack.ELECTRIC.getItem(20), 300, 8);
        // --- Electric Switch
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(10), EnumTrack.ELECTRIC.getItem(1),
                        RailcraftItem.rail.getStack(1, ItemRail.EnumRail.ELECTRIC),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 1L)},
                EnumTrack.ELECTRIC_SWITCH.getItem(2), 200, 6);
        // --- Electric WYE
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(15), EnumTrack.ELECTRIC.getItem(1),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.ELECTRIC),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 1L)},
                EnumTrack.ELECTRIC_WYE.getItem(2), 200, 6);
        // --- Electric Junction
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(20),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ELECTRIC),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Copper, 2L)},
                EnumTrack.ELECTRIC_JUNCTION.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(20), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(8, ItemRail.EnumRail.ELECTRIC),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.AnnealedCopper, 2L)},
                EnumTrack.ELECTRIC_JUNCTION.getItem(10), 300, 8);

        // --- H.S Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(1),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.SPEED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Aluminium, 2L)},
                EnumTrack.SPEED.getItem(8), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(1), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.SPEED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.SPEED.getItem(20), 200, 6);
        // --- H.S Booster Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.SPEED),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Aluminium, 2L)},
                EnumTrack.SPEED_BOOST.getItem(4), 200, 6);
        // --- H.S Switch
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(10), EnumTrack.SPEED.getItem(1),
                        RailcraftItem.rail.getStack(1, ItemRail.EnumRail.SPEED),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 1L)},
                EnumTrack.SPEED_SWITCH.getItem(2), 200, 6);
        // --- H.S WYE
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(15), EnumTrack.SPEED.getItem(1),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.SPEED),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 1L)},
                EnumTrack.SPEED_WYE.getItem(2), 200, 6);
        // --- H.S Transition Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(20),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.SPEED),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Aluminium, 2L)},
                EnumTrack.SPEED_TRANSITION.getItem(4), 200, 6);
        ...
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                new ItemStack(Blocks.golden_rail, 4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(5),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                new ItemStack(Blocks.golden_rail, 8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(5), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                new ItemStack(Blocks.golden_rail, 16), 400, 12);
        // --- Switch
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(10), new ItemStack(Blocks.rail),
                        RailcraftItem.rail.getStack(1, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Iron, 1L)},
                EnumTrack.SWITCH.getItem(2), 200, 6);
        // --- WYE
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(15), new ItemStack(Blocks.rail),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Iron, 1L)},
                EnumTrack.WYE.getItem(2), 200, 6);
        // --- Junction
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(20),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.JUNCTION.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(20),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(8, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.JUNCTION.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(20), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(10, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.JUNCTION.getItem(16), 400, 12);
        ...
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.CONTROL.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED),
                        GT_OreDictUnificator.get(OrePrefixes.stick, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.CONTROL.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.CONTROL.getItem(16), 400, 12);
        // --- Locking Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.ADVANCED),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.LOCKING.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED),
                        new ItemStack(Blocks.stone_pressure_plate),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.LOCKING.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED),
                        new ItemStack(Blocks.stone_pressure_plate),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.LOCKING.getItem(16), 400, 12);
        // --- Disembarking Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.ADVANCED), EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.DISEMBARK.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED), EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.DISEMBARK.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED),
                        EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.DISEMBARK.getItem(16), 400, 12);
        // --- Embarking Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.ADVANCED), EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.EMBARKING.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED), EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.EMBARKING.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED),
                        EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.EMBARKING.getItem(16), 400, 12);
        // --- Coupler Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.ADVANCED), ItemCrowbarReinforced.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.COUPLER.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED), ItemCrowbarReinforced.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.COUPLER.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED),
                        ItemCrowbarReinforced.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.COUPLER.getItem(16), 400, 12);
        // --- Whistle Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.ADVANCED), ItemWhistleTuner.getItem(),
                        ItemList.Casing_Stripes_A.get(1),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.WHISTLE.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED), ItemWhistleTuner.getItem(),
                        ItemList.Casing_Stripes_A.get(1),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.WHISTLE.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED), ItemWhistleTuner.getItem(),
                        ItemList.Casing_Stripes_A.get(1),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.WHISTLE.getItem(16), 400, 12);
        // --- Locomotive Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD),
                        EnumSignal.BLOCK_SIGNAL.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.LOCOMOTIVE.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD),
                        EnumSignal.BLOCK_SIGNAL.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.LOCOMOTIVE.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD),
                        EnumSignal.BLOCK_SIGNAL.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.LOCOMOTIVE.getItem(16), 400, 12);
        // --- Limiter Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD), EnumDetector.ANY.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.LIMITER.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD), EnumDetector.ANY.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.LIMITER.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD), EnumDetector.ANY.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.LIMITER.getItem(16), 400, 12);
        // --- Routing Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD), ItemTicket.getTicket(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.ROUTING.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD), ItemTicketGold.getTicket(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.ROUTING.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD), ItemTicket.getTicket(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.ROUTING.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD), ItemTicketGold.getTicket(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.ROUTING.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD), ItemTicket.getTicket(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.ROUTING.getItem(16), 400, 12);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD), ItemTicketGold.getTicket(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.ROUTING.getItem(16), 400, 12);
        // --- Buffer Stop
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.BUFFER_STOP.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.block, Materials.Iron, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.BUFFER_STOP.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.block, Materials.Iron, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.BUFFER_STOP.getItem(16), 400, 12);
        // --- One Way Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD), new ItemStack(Blocks.piston),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.ONEWAY.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD), new ItemStack(Blocks.piston),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.ONEWAY.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD),
                        new ItemStack(Blocks.piston),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.ONEWAY.getItem(16), 400, 12);
        // --- Directional Detector
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD), EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.DETECTOR_DIRECTION.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD), EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.DETECTOR_DIRECTION.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD),
                        EnumDetector.ADVANCED.getItem(),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.DETECTOR_DIRECTION.getItem(16), 400, 12);
        // --- Gated One Way Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.ADVANCED), new ItemStack(Blocks.fence),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.GATED_ONEWAY.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.ADVANCED), new ItemStack(Blocks.fence),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.GATED_ONEWAY.getItem(8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.ADVANCED), new ItemStack(Blocks.fence),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.GATED_ONEWAY.getItem(16), 400, 12);
        // --- Gated Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD), new ItemStack(Blocks.fence),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)}, EnumTrack.GATED.getItem(4),
                200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD), new ItemStack(Blocks.fence),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)}, EnumTrack.GATED.getItem(8),
                300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
        ...
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        ...
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.SUSPENDED.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.tie.getStack(3, ItemTie.EnumTie.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.SUSPENDED.getItem(8), 300, 8);
        // --- Disposal Rail
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8),
                        RailcraftItem.tie.getStack(2, ItemTie.EnumTie.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.DISPOSAL.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(8),
                        RailcraftItem.tie.getStack(2, ItemTie.EnumTie.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                EnumTrack.DISPOSAL.getItem(8), 300, 8);
        // --- Priming Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.REINFORCED),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.PRIMING.getItem(4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.REINFORCED),
                        new ItemStack(Items.flint_and_steel),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSLA, 2L)},
                EnumTrack.PRIMING.getItem(10), 300, 8);
        // --- Launcher Track
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), EnumTrack.REINFORCED.getItem(),
                        new ItemStack(Blocks.piston),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.RedAlloy, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.block, Materials.Steel, 1L),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                EnumTrack.LAUNCHER.getItem(4), 200, 6);
        // --- Detector Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD),
                        new ItemStack(Blocks.stone_pressure_plate),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                new ItemStack(Blocks.detector_rail, 4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD),
                        new ItemStack(Blocks.stone_pressure_plate),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                new ItemStack(Blocks.detector_rail, 8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD),
                        new ItemStack(Blocks.stone_pressure_plate),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                new ItemStack(Blocks.detector_rail, 16), 400, 12);
        // --- Activator Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                new ItemStack(Blocks.activator_rail, 4), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD),
                        new ItemStack(Blocks.redstone_torch),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                new ItemStack(Blocks.activator_rail, 8), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD),
                        new ItemStack(Blocks.redstone_torch),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel, 2L)},
                new ItemStack(Blocks.activator_rail, 16), 400, 12);
        // --- NFC Track
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.WOOD),
                        RailcraftItem.rail.getStack(2, ItemRail.EnumRail.STANDARD),
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                new ItemStack(Objects.nfcTrack, 4, 0), 200, 6);
        impact.I_RA.addTrackAssemblerRecipe(new ItemStack[]{GT_Utility.getIntegratedCircuit(7),
                        RailcraftItem.railbed.getStack(1, ItemRailbed.EnumRailbed.STONE),
                        RailcraftItem.rail.getStack(4, ItemRail.EnumRail.STANDARD),
                        new ItemStack(Objects.metaItem, 1, 3),
                        GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Iron, 2L)},
                new ItemStack(Objects.nfcTrack, 8, 0), 300, 8);
        impact.I_RA.addTrackAssemblerRecipe(
                new ItemStack[]{GT_Utility.getIntegratedCircuit(7), CoreItems2.getRecipe(165, 1),
                        RailcraftItem.rail.getStack(6, ItemRail.EnumRail.STANDARD),
                        new ItemStack(Objects.metaItem, 1, 3),
