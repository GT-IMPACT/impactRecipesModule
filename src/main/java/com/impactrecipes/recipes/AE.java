...
public class AE implements Runnable {
    ...
    private void handRecipe() {
        ...
        // --- Pattern Encoder
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem("ae2stuff", "Encoder", 1L, 0), tBitMask, new Object[]{"POP", "ACA", "PEP", 'P', OrePrefixes.plate.get(Materials.VanadiumSteel), 'O', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 340), 'A', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23), 'C', GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockCraftingUnit", 1L, 0), 'E', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 16)});
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolCertusQuartzCuttingKnife", 1L),
                tBitMask, new Object[]{"  S", " S ", "Gf ", 'G', OrePrefixes.gem.get(Materials.CertusQuartz), 'S', OrePrefixes.stick.get(Materials.Wood)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolNetherQuartzCuttingKnife", 1L),
                tBitMask, new Object[]{"  S", " S ", "Gf ", 'G', OrePrefixes.gem.get(Materials.NetherQuartz), 'S', OrePrefixes.stick.get(Materials.Wood)});
        ...
        // --- ME Storage Housing
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 39), tBitMask,
        ...
        // --- ME Interface
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockInterface", 1L, 0), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 440)});
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 440), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockInterface", 1L, 0)});
        // --- ME Conversion Monitor
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 420), tBitMask,
        ...
        // --- Cell Workbench
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockCellWorkbench", 1L, 0), tBitMask,
        ...
        // --- ME IO Port
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockIOPort", 1L, 0), tBitMask,
        ...
        // --- Matter Condenser
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockCondenser", 1L, 0), tBitMask,
        ...
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockSecurity", 1L, 0), tBitMask,
                new Object[]{"PMP", "ACA", "POP", 'P', OrePrefixes.plate.get(Materials.VanadiumSteel),
                        ...
                        'M', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 480)});
        // --- Meteorite Compass
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockSkyCompass", 1L, 0), tBitMask,
        ...
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockSkyCompass", 1L, 0), tBitMask,
                new Object[]{"hGS", "PRP", "SPd", 'P', OrePrefixes.plate.get(Materials.Steel), 'S', OrePrefixes.screw.get(Materials.CertusQuartz),
                        'R', OrePrefixes.stick.get(Materials.SteelMagnetic), 'G', OrePrefixes.plate.get(Materials.Glass)});
        // --- Network Tool
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolNetworkTool", 1L, 0), tBitMask,
        ...
        // --- Fluix Pearl
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 9), tBitMask,
        ...
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 9), tBitMask,
                new Object[]{"QPQ", "POP", "QPQ", 'P', OrePrefixes.plate.get(Materials.Grisium),
                        ...
                        'O', OrePrefixes.lens.get(Materials.EnderPearl)});
        // --- Terminal
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 380), tBitMask,
        ...
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 380), tBitMask,
                new Object[]{"RdR", "ICP", "RSR", 'R', OrePrefixes.stick.get(Materials.NetherQuartz), 'S', OrePrefixes.screw.get(Materials.Quartzite),
                        'I', "itemIlluminatedPanel", 'C', OrePrefixes.circuit.get(Materials.Good), 'P', OrePrefixes.plate.get(Materials.CertusQuartz)});
        // --- Crafting Terminal
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 360), tBitMask,
        ...
        // --- Interface Terminal
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 480), tBitMask,
                new Object[]{"dTh", "SOS", "PCP", 'S', OrePrefixes.screw.get(Materials.CertusQuartz), 'P', OrePrefixes.plate.get(Materials.NetherQuartz),
                        'T', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 380),
        ...
        // --- Pattern Terminal
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 340), tBitMask,
                new Object[]{"dTh", "SOS", "PCP", 'S', OrePrefixes.screw.get(Materials.CertusQuartz), 'P', OrePrefixes.plate.get(Materials.NetherQuartz),
                        'T', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 380),
                        'O', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 52),
                        'C', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24)});
        // --- Storage Monitor
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 400), tBitMask,
        ...
        // --- Wireless Terminal
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolWirelessTerminal", 1L, 0), tBitMask,
        ...
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockQuartzLamp", 1L, 0), tBitMask,
        ...
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockQuartzTorch", 1L, 0), tBitMask,
                new Object[]{OrePrefixes.gem.get(Materials.CertusQuartz), OrePrefixes.stick.get(Materials.Aluminium)});
        // --- Light Detecting Fixture
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockLightDetector", 1L, 0), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 1),
                        OrePrefixes.stick.get(Materials.Iron)});
        // --- Advanced Card
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 28), tBitMask,
                new Object[]{"PVS", "RCV", "PVS", 'P', OrePrefixes.plate.get(Materials.Platinum), 'V', OrePrefixes.plate.get(Materials.VanadiumSteel),
                        ...
                        'C', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23)});
        // --- Basic Card
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 25), tBitMask,
                new Object[]{"PVS", "RCV", "PVS", 'P', OrePrefixes.plate.get(Materials.Gold), 'V', OrePrefixes.plate.get(Materials.VanadiumSteel),
                        ...
                        'C', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23)});
        // --- Capacity Card
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 27), tBitMask,
        ...
        // --- Card Upgrade
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 54), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 28),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 1)});
        // --- Crafting Card
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 53), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 25),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23),
                        "craftingWorkBench"});
        // --- Redstone Card
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 26), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 25),
                        "craftingRedstoneTorch", "craftingRedstoneTorch",
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23)});
        // --- Fuzzy Card
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 29), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 28),
                        ...
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23)});
        // --- Inverter Card
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 31), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 28),
                        GT_ModHandler.getModItem("IC2", "upgradeModule", 1L, 5),
                        GT_ModHandler.getModItem("IC2", "upgradeModule", 1L, 5),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23)});
        // --- Acceleration Card
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 30), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 28),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 22),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 7)});
        // --- Wireless Booster
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 42), tBitMask,
        ...
        // --- ME Formation Plane
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 320), tBitMask,
                new Object[]{"DDD", "PAP", 'P', OrePrefixes.plate.get(Materials.VanadiumSteel),
                        'D', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 8),
                        'A', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 43)});
        // --- ME Toggle Bus
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 80), tBitMask,
        ...
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 80), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 100)});
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 100), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 80)});
        // --- Cable Anchor
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 2L, 120), tBitMask,
        ...
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 3L, 120), tBitMask,
        ...
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 4L, 120), tBitMask,
        ...
        // --- Matter Cannon
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolMassCannon", 1L, 0), tBitMask,
                new Object[]{"PPA", "BE ", "P  ", 'P', OrePrefixes.plate.get(Materials.VanadiumSteel),
                        ...
                        'E', GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockDenseEnergyCell", 1L, 0)});
        // --- Memory Card
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolMemoryCard", 1L, 0), tBitMask,
                new Object[]{"CPP", "GAG", 'P', OrePrefixes.plate.get(Materials.VanadiumSteel), 'G', OrePrefixes.plate.get(Materials.Gold),
                        ...
                        'C', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23)});
        // --- Color Applicator
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolColorApplicator", 1L, 0), tBitMask,
        ...
        // --- Biometric Card
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolBiometricCard", 1L, 0), tBitMask,
                new Object[]{"CPP", "GAG", 'P', OrePrefixes.plate.get(Materials.VanadiumSteel), 'G', OrePrefixes.plate.get(Materials.Gold),
                        'A', OrePrefixes.plate.get(Materials.RedAlloy),
                        'C', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24)});
        // --- Portable Cell
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ToolPortableCell", 1L, 0), tBitMask,
        ...
        // --- Spatial storage fix
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemSpatialStorageCell.2Cubed", 1L, 0), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemSpatialStorageCell.2Cubed", 1L, 0)});
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemSpatialStorageCell.16Cubed", 1L, 0), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemSpatialStorageCell.16Cubed", 1L, 0)});
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemSpatialStorageCell.128Cubed", 1L, 0), tBitMask,
                new Object[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemSpatialStorageCell.128Cubed", 1L, 0)});
        // --- Illuminated Panel
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 180), tBitMask,
        ...
        addShapelessCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 180), tBitMask,
        ...
        // --- Blank Pattern
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 52), tBitMask,
        ...
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 4L, 52), tBitMask,
                new Object[]{"WWW", "PCP", "PQP", 'P', OrePrefixes.plate.get(Materials.Plastic),
        ...
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 16L, 52), tBitMask,
                new Object[]{"WWW", "PCP", "PQP", 'P', OrePrefixes.plate.get(Materials.Plastic),
        ...
        // --- Energy Cell
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockEnergyCell", 1L, 0), tBitMask,
        ...
        // --- Dense Energy Cell
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockDenseEnergyCell", 1L, 0), tBitMask,
        ...
        // --- Annihilation Core
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 44), tBitMask,
        ...
        // --- Formation Core
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 43), tBitMask,
                new Object[]{"SFh", "PCG", "SFd", 'P', OrePrefixes.plate.get(Materials.CertusQuartz),
                        'F', OrePrefixes.foil.get(Materials.VanadiumSteel), 'S', OrePrefixes.screw.get(Materials.Quartzite),
                        'C', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 7),
                        'G', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 22)});
        // --- Wireless Access Point
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockWireless", 1L, 0), tBitMask,
                new Object[]{"SIS", "PCP", "dAw", 'P', OrePrefixes.plate.get(Materials.Vanadium), 'S', OrePrefixes.screw.get(Materials.Titanium),
                        ...
                        'A', GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 16)});
        // --- Wireless Receiver
        addCraftingRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 41), tBitMask,
    ...
    private void assemblerRecipe() {
        ...
        // --- Level Emitter
        RA.addAssemblerRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 23),
        ...
        // --- Fluix Glass Cable
        RA.addAssemblerRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 2L, 140),
        ...
        RA.addAssemblerRecipe(
                ...
                7680);
        RA.addAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_Ram.get(32),
                ...
                30720);
        RA.addAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_NAND.get(16),
        ...
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3), GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 4L, 38), ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldAdvancedCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 0), 280, 30720);

        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3), GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 3L, 38), ItemList.Circuit_Chip_SoC2.get(1), GT_ItemList.EmeraldAdvancedCoreChip.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 0), 30, 122880);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 1), GT_ModHandler.getModItem("extracells", "storage.component", 2L, 0), ItemList.Circuit_Chip_SoC3.get(1), GT_ItemList.EngravedEnergyChip.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 1), 30, 500000);

        // --- Storage Cell Component - 4096K
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 1), ItemList.Circuit_Chip_NAND.get(4), GT_ItemList.EngineeringProcessorItemAdvEmeraldCore.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), 240, 30720);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 3), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 1), ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldHighAdvancedCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), 320, 122880);

        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 3), GT_ModHandler.getModItem("extracells", "storage.component", 3L, 1), ItemList.Circuit_Chip_SoC3.get(1), GT_ItemList.EmeraldHighAdvancedCoreChip.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), 30, 500000);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Superconductor, 1), GT_ModHandler.getModItem("extracells", "storage.component", 2L, 2), ItemList.Circuit_Chip_SoC4.get(1), GT_ItemList.EngravedQuantumChip.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Phoenixite.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 3), 30, 2000000);

        // --- Fluid Storage Cell Component - 1K
        RA.addAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis, 4), GT_ItemList.EngineeringProcessorFluidGoldCore.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 4), 120, 480);
        RA.addAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_NAND.get(3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis, 4), GT_ItemList.GoldFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 4), 160, 1920);

        // --- Fluid Storage Cell Component - 4K
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 4), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 4), ItemList.Circuit_Chip_Ram.get(4), GT_ItemList.EngineeringProcessorFluidGoldCore.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 5), 160, 480);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 3), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 4), ItemList.Circuit_Chip_NAND.get(3), GT_ItemList.GoldFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 5), 240, 1920);

        // --- Fluid Storage Cell Component - 16K
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 4), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 5), ItemList.Circuit_Chip_Ram.get(4), GT_ItemList.EngineeringProcessorFluidDiamondCore.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 6), 180, 1920);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 3), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 5), ItemList.Circuit_Chip_NAND.get(3), GT_ItemList.DiamondFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 6), 260, 7680);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 4), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 6), ItemList.Circuit_Chip_Ram.get(4), GT_ItemList.EngineeringProcessorFluidDiamondCore.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7), 200, 1920);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 3), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 6), ItemList.Circuit_Chip_NAND.get(3), GT_ItemList.DiamondFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7), 280, 7680);

        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 3), GT_ModHandler.getModItem("extracells", "storage.component", 3L, 6), ItemList.Circuit_Chip_SoC.get(1), GT_ItemList.DiamondFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Europium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7), 30, 30720);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 1), GT_ModHandler.getModItem("extracells", "storage.component", 2L, 6), ItemList.Circuit_Chip_SoC2.get(1), ItemList.Circuit_Parts_Crystal_Chip_Master.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 7), 30, 122880);

        // --- Fluid Storage Cell Component - 256K
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 4), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 7), ItemList.Circuit_Chip_NAND.get(4), GT_ItemList.EngineeringProcessorFluidEmeraldCore.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 8), 200, 7680);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 7), ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 8), 280, 30720);

        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3), GT_ModHandler.getModItem("extracells", "storage.component", 3L, 7), ItemList.Circuit_Chip_SoC2.get(1), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 8), 30, 122880);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 1), GT_ModHandler.getModItem("extracells", "storage.component", 2L, 8), ItemList.Circuit_Chip_SoC3.get(1), ItemList.Circuit_Parts_Crystal_Chip_Master.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 9), 30, 500000);

        // --- Fluid Storage Cell Component - 4096K
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 9), ItemList.Circuit_Chip_NAND.get(4), GT_ItemList.EngineeringProcessorFluidEmeraldCore.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 10), 240, 30720);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 3), GT_ModHandler.getModItem("extracells", "storage.component", 4L, 9), ItemList.Circuit_Chip_NOR.get(3), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(1)}, null, GT_ModHandler.getModItem("extracells", "storage.component", 1L, 10), 320, 122880);

        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 3), GT_ModHandler.getModItem("extracells", "storage.component", 3L, 9), ItemList.Circuit_Chip_SoC3.get(1), GT_ItemList.EmeraldAdvancedFluidCoreChip.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Neutronium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 10), 30, 500000);
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        GT_OreDictUnificator.get(OrePrefixes.block, Materials.NeodymiumMagnetic, 2L),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 28),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 24),
                        GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.HastelloyN, 8),
                        GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Inconel792, 24)}, null,
                GT_ModHandler.getModItem("ae2wct", "magnetCard", 1L, 0), 1000, 1920);
        // --- Booster
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 64L, 42),
                        ItemList.Field_Generator_UV.get(1L),
                        GT_OreDictUnificator.get(OrePrefixes.plate, Materials.CinobiteA243, 16),
                        GT_OreDictUnificator.get(OrePrefixes.stickLong, Materials.Quantium, 24),
        ...
        for (int i = 0; i < 16; i++) {
            for (int j = 0; j < Dyes.VALUES[i].getSizeOfFluidList(); j++) {
                ...
                RA.addChemicalBathRecipe(
                        ...
                        GT_Values.NI, GT_Values.NI, null, 20, 2);
                RA.addChemicalBathRecipe(
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 536),
                        Dyes.VALUES[i].getFluidDye(j, 36L),
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 535 - i),
                        GT_Values.NI, GT_Values.NI, null, 20, 2);
            }
            RA.addChemicalBathRecipe(
                    GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 15 - i),
    ...
    private void chemicalReactorRecipe() {
        ...
        RA
                .addChemicalRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 8),
                        GT_ModHandler.getModItem("minecraft", "sand", 1L, 1), null, null,
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemCrystalSeed", 2L, 1200), 100);
        RA.addChemicalRecipe(CoreItems.getRecipe(38, 3), Materials.Sodium.getDust(1),
    ...
    private void cuttingSawRecipe() {
        ...
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Copper, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 4L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 6L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Tin, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 4L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 8L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Aluminium, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 8L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Lead, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 4L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Nickel, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 4L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silver, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 4L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Brass, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 6L, 120), GT_Values.NI, 80, 8);
        RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Invar, 1L),
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 6L, 120), GT_Values.NI, 80, 8);
    }
...
/*Processor*/, GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 4),
    ...
    private void pulveriserRecipe() {
        RA.addPulveriserRecipe(GT_ModHandler.getModItem("appliedenergistics2", "tile.BlockFluix", 1L), new ItemStack[]{GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 4L, 7)}, new int[]{10000}, 300, 2);
        RA.addPulveriserRecipe(GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiMaterial", 1L, 1), new ItemStack[]{CoreItems.getRecipe(38, 1)}, new int[]{10000}, 300, 2);
    }
    ...
    private void wireAssemblerRecipe() {
        ...
        RA.addWireAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 76),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.PolyphenyleneSulfide, 2),
                        GT_Utility.getIntegratedCircuit(24)},
                Materials.Silicone.getMolten(144), GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1L, 536),
                100, 8, false);
        RA.addWireAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 2L, 76),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.PolyvinylChloride, 1),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.PolyphenyleneSulfide, 4)},
                Materials.StyreneButadieneRubber.getMolten(144), GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 2L, 536),
                200, 8, false);
        RA.addWireAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 2L, 76),
                        GT_OreDictUnificator.get(OrePrefixes.dust, Materials.PolyvinylChloride, 1),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.PolyphenyleneSulfide, 4)},
                Materials.Silicone.getMolten(144), GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 2L, 536),
                200, 8, false);
        RA.addWireAssemblerRecipe(new ItemStack[]{
                        GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 2L, 76),
