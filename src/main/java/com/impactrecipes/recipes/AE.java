...
public class AE implements Runnable {
    ...
    private void removeAE() {
        ...
        removeRecipeByOutput(GT_ModHandler.getModItem("AE2-GT5-P2P", "part", 1L));
    ...
    private void handRecipe() {
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem("extracells", "storage.casing", 1L), tBitMask, new Object[]{"hGS", "TOT", "SVd", 'O', GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 39), 'T', OrePrefixes.plate.get(Materials.Iridium), 'V', OrePrefixes.plate.get(Materials.HastelloyC276), 'S', OrePrefixes.screw.get(Materials.CertusQuartz), 'G', OrePrefixes.plate.get(Materials.ReinforcedGlass)});
        ...
        // --- Acceleration Card
        addShapelessCraftingRecipe(GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 30), tBitMask, new Object[]{GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 28), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 24), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 22), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 7)});
        // --- Wireless Booster
        ...
        // --- ME Block Container
        addCraftingRecipe(GT_ModHandler.getModItem("extracells", "storage.physical", 1L, 4), tBitMask, new Object[]{" A ", "SBS", "dIw", 'S', OrePrefixes.screw.get(Materials.VanadiumSteel), 'A', GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 35), 'B', GT_ModHandler.getModItem(AE2, "tile.BlockChest", 1L), 'I', GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 39)});
        // --- ME Block Container
        addCraftingRecipe(GT_ModHandler.getModItem("extracells", "storage.fluid.portable", 1L), tBitMask, new Object[]{" A ", "SBS", "dIw", 'S', OrePrefixes.screw.get(Materials.VanadiumSteel), 'A', GT_ModHandler.getModItem("extracells", "storage.component", 1L, 4), 'B', GT_ModHandler.getModItem(AE2, "tile.BlockChest", 1L), 'I', GT_ModHandler.getModItem(AE2, "tile.BlockEnergyCell", 1L)});
    ...
    private void alloySmelterRecipe() {
        ...
        // --- Quartz Tank
        RA.addAlloySmelterRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockQuartzGlass", 8L), ItemList.Shape_Mold_Block.get(0), GT_ModHandler.getModItem("extracells", "certustank", 1L), 800, 30);
    ...
    private void assemblerRecipe() {
        ...
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem("extracells", "storage.component", 1L), Materials.SolderingAlloy.getMolten(9216), GT_ModHandler.getModItem("extracells", "craftingstorage", 1L), 1200, 16384);
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 1), Materials.SolderingAlloy.getMolten(18432), GT_ModHandler.getModItem("extracells", "craftingstorage", 1L, 1), 1200, 65536);
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), Materials.SolderingAlloy.getMolten(36864), GT_ModHandler.getModItem("extracells", "craftingstorage", 1L, 2), 1200, 262144);
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 3), Materials.SolderingAlloy.getMolten(36864), GT_ModHandler.getModItem("extracells", "craftingstorage", 1L, 3), 1200, 1048576);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data, 3), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 3L, 38), ItemList.Circuit_Chip_SoC2.get(1), GT_ItemList.EmeraldAdvancedCoreChip.get(1L), GT_Utility.getIntegratedCircuit(2)}, Materials.Americium.getMolten(36), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 0), 30, 122880);
        ...
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "item.ItemMultiPart", 1L, 280), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Lapis, 1), GT_ModHandler.getModItem("extracells", "part.base", 1L, 4), 100, 120);
    ...
    private void autoclaveRecipe() {
        ...
        RA
                .addAutoclaveRecipe(CoreItems.getRecipe(38, 1), GT_ModHandler.getDistilledWater(1000), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 1), 9000, 1500, 24);
    }
...
/*Processor*/, GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 4), GT_ModHandler.getModItem(AE2, "item.ItemMultiPart", 4, 56), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.VanadiumSteel, 12)}, GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1, 0), null, 30 * 20, 1920);
    ...
    private void unboxingRecipe() {
        ...
        RA.addUnboxingRecipe(GT_ModHandler.getModItem("extracells", "craftingstorage", 1L, 0), GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 0), 50, 96);
        RA.addUnboxingRecipe(GT_ModHandler.getModItem("extracells", "craftingstorage", 1L, 1), GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 1), 50, 120);
        RA.addUnboxingRecipe(GT_ModHandler.getModItem("extracells", "craftingstorage", 1L, 2), GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 2), 50, 192);
        RA.addUnboxingRecipe(GT_ModHandler.getModItem("extracells", "craftingstorage", 1L, 3), GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem("extracells", "storage.component", 1L, 3), 50, 250);
    }
    ...
    private void meSystemProvider() {
        ...
        impact.I_RA.addMESPRecipes(new ItemStack[]{ItemList.Hatch_Input_HV.get(1L), ItemList.Hatch_Output_HV.get(1L), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.HSLA, 4), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 3, 44), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 3, 43), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Vanadium, 6)}, GT_ModHandler.getModItem("extracells", "part.base", 4, 2), 400, 1920, 200);
        impact.I_RA.addMESPRecipes(new ItemStack[]{ItemList.Hatch_Input_EV.get(1L), ItemList.Hatch_Output_EV.get(1L), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.HSSG, 4), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 4, 44), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 4, 43), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Vanadium, 8)}, GT_ModHandler.getModItem("extracells", "part.base", 8, 2), 500, 7680, 400);
        ...
        impact.I_RA.addMESPRecipes(new ItemStack[]{ItemList.Hatch_Input_LuV.get(1L), ItemList.Hatch_Output_LuV.get(1L), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.HastelloyN, 4), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 6, 44), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 6, 43), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Vanadium, 16)}, GT_ModHandler.getModItem("extracells", "part.base", 16, 2), 700, 122880, 800);
        ...
        impact.I_RA.addMESPRecipes(new ItemStack[]{ItemList.Hatch_Input_UV.get(1L), ItemList.Hatch_Output_UV.get(1L), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.CinobiteA243, 4), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 8, 44), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 8, 43), GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Vanadium, 24)}, GT_ModHandler.getModItem("extracells", "part.base", 32, 2), 900, 2000000, 1600);
    }
}
