...
public class AE implements Runnable {
    ...
    private void assemblerRecipe() {
        ...
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 39), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 36), GT_ModHandler.getModItem(AE2, "item.ItemBasicStorageCell.4k", 1L), 100, 250);
        ...
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 39), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 38), GT_ModHandler.getModItem(AE2, "item.ItemBasicStorageCell.64k", 1L), 100, 1020);
        ...
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 39), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 34), GT_ModHandler.getModItem(AE2, "item.ItemSpatialStorageCell.128Cubed", 1L), 400, 16350);
        // --- CoCraftingUnit
        ...
        // --- CraftingStorages
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 35), Materials.SolderingAlloy.getMolten(144), GT_ModHandler.getModItem(AE2, "tile.BlockCraftingStorage", 1L, 0), 1200, 60);
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 36), Materials.SolderingAlloy.getMolten(576), GT_ModHandler.getModItem(AE2, "tile.BlockCraftingStorage", 1L, 1), 1200, 250);
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 37), Materials.SolderingAlloy.getMolten(2304), GT_ModHandler.getModItem(AE2, "tile.BlockCraftingStorage", 1L, 2), 1200, 1020);
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 38), Materials.SolderingAlloy.getMolten(9216), GT_ModHandler.getModItem(AE2, "tile.BlockCraftingStorage", 1L, 3), 1200, 4090);
        RA.addAssemblerRecipe(GT_ModHandler.getModItem(AE2, "tile.BlockCraftingUnit", 1L, 0), GT_ModHandler.getModItem(AE2, "item.ItemMultiMaterial", 1L, 57), Materials.SolderingAlloy.getMolten(9216), GT_ModHandler.getModItem(AE2, "tile.BlockAdvancedCraftingStorage", 1L), 1200, 16350);
