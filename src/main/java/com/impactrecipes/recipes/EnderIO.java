...
public class EnderIO implements Runnable {
    ...
    public void handRecipe() {
        ...
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemFunctionUpgrade, 1, 0), tBitMask,
        ...
        // --- YetaWrench
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemYetaWench, 1, 0), tBitMask,
                new Object[]{"IhI", "IGI", " I ", 'I', OrePrefixes.ingot.get(Materials.Steel), 'G',
                        OrePrefixes.gear.get(Materials.Steel)});
        // --- Travel Anchor
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockTravelPlatform, 1, 0), tBitMask,
                new Object[]{"PGP", "COC", "PFP", 'O', new ItemStack(crazypants.enderio.EnderIO.itemMachinePart, 1, 0), 'P',
        ...
        // --- Painter
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockPainter, 1, 0),
                new Object[]{"PRP", "CMC", "LRL", 'R', OrePrefixes.rotor.get(Materials.Steel), 'P',
                        OrePrefixes.plate.get(Materials.Steel), 'C', OrePrefixes.circuit.get(Materials.Basic),
                        'L', ItemList.Electric_Motor_LV.get(1L), 'M',
                        new ItemStack(crazypants.enderio.EnderIO.itemMachinePart, 1, 0)});
        // --- Casing
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemMachinePart, 1, 0),
                new Object[]{"PBP", "BCB", "PBP", 'P', OrePrefixes.plate.get(Materials.ElectricalSteel),
                        'C', new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 0), 'B',
                        new ItemStack(Blocks.iron_bars, 1, 0)});
        // --- Basic Capacitor
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockCapBank, 1, 1),
                new Object[]{"CIC", "PMP", "CBC", 'P', OrePrefixes.plate.get(Materials.ConductiveIron), 'C',
                        new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 0), 'I',
                        OrePrefixes.circuit.get(Materials.Basic), 'B', ItemList.Battery_RE_LV_Lithium, 'M',
                        new ItemStack(crazypants.enderio.EnderIO.itemMachinePart, 1, 0)});
        // --- Energetic Capacitor
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockCapBank, 1, 2),
                new Object[]{"CIC", "PMP", "CBC", 'P', OrePrefixes.plate.get(Materials.EnergeticAlloy), 'C',
                        new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 1), 'I',
                        OrePrefixes.circuit.get(Materials.Good), 'B', ItemList.Battery_RE_MV_Lithium, 'M',
                        new ItemStack(crazypants.enderio.EnderIO.blockCapBank, 1, 1)});
        // --- Vibrant Capacitor
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockCapBank, 1, 3),
                new Object[]{"CIC", "PMP", "CBC", 'P', OrePrefixes.plate.get(Materials.VibrantAlloy), 'C',
                        new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 2), 'I',
                        OrePrefixes.circuit.get(Materials.Advanced), 'B', ItemList.Battery_RE_HV_Lithium, 'M',
                        new ItemStack(crazypants.enderio.EnderIO.blockCapBank, 1, 2)});
        // --- Crafter
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockCrafter, 1, 0),
                new Object[]{"POP", "IMI", "PCP", 'P', OrePrefixes.itemCasing.get(Materials.Steel), 'C',
                        new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 0), 'I',
                        OrePrefixes.circuit.get(Materials.Basic), 'M',
                        new ItemStack(crazypants.enderio.EnderIO.itemMachinePart, 1, 0), 'O', ItemList.Cover_Crafting});
        // --- Wireless Charger
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockWirelessCharger, 1, 0),
                new Object[]{"POP", "IMI", "PCP", 'P', OrePrefixes.plate.get(Materials.ElectricalSteel),
                        'C', new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 2), 'I',
                        OrePrefixes.circuit.get(Materials.Advanced), 'M',
                        new ItemStack(crazypants.enderio.EnderIO.itemMachinePart, 1, 0), 'O', ItemList.Field_Generator_MV});
        // --- Staff of Travelling
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemTravelStaff, 1, 16),
                new Object[]{"dCE", "SIC", "ISw", 'I', OrePrefixes.stick.get(Materials.DarkSteel), 'C',
                        OrePrefixes.circuit.get(Materials.Advanced), 'S',
                        OrePrefixes.screw.get(Materials.VibrantAlloy), 'E', ItemList.Sensor_HV});
        // --- DarkSteel Pressure Plate
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockDarkSteelPressurePlate, 1, 0),
        ...
        // --- DarkIron Bars
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockDarkIronBars, 3, 0),
                new Object[]{" h ", "SSS", "SSS", 'S', OrePrefixes.stick.get(Materials.DarkSteel)});
        // --- Farming Station
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockFarmStation, 1, 0),
                new Object[]{"RPR", "IMI", "GCG", 'P', OrePrefixes.plateDense.get(Materials.PulsatingIron),
                        'G', OrePrefixes.gearGt.get(Materials.ElectricalSteel), 'C',
                        new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 2), 'I',
                        OrePrefixes.circuit.get(Materials.Advanced), 'M',
                        new ItemStack(crazypants.enderio.EnderIO.itemMachinePart, 1, 0), 'R', ItemList.Robot_Arm_HV});
        // --- Conduit Probe
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemConduitProbe, 1, 0),
                new Object[]{"SIS", "CMC", "ERE", 'S', OrePrefixes.plate.get(Materials.Silicon), 'E',
                        OrePrefixes.plate.get(Materials.ElectricalSteel), 'I',
                        new ItemStack(crazypants.enderio.EnderIO.itemPowerConduit, 1, 0), 'C',
                        OrePrefixes.circuit.get(Materials.Basic), 'M',
                        GT_ModHandler.getModItem("ProjRed|Integration", "projectred.integration.gate", 1L, 26),
                        'R', new ItemStack(crazypants.enderio.EnderIO.itemRedstoneConduit, 1, 2)});
        // --- Buffer
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockBuffer, 1, 0),
                new Object[]{"ISI", "SCS", "ISI", 'S', OrePrefixes.plate.get(Materials.Steel), 'I',
                        OrePrefixes.plate.get(Materials.Iron), 'C', new ItemStack(Blocks.chest)});
        // --- Magnet
        GT_ModHandler.addCraftingRecipe(new ItemStack(DarkSteelItems.itemMagnet, 1, 16),
        ...
        // --- Powered Light
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 1, 0),
                new Object[]{"QQQ", "PDP", "PCP", 'Q', new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 1, 0), 'P',
                        OrePrefixes.plate.get(Materials.Silicon), 'D',
                        GT_ModHandler.getModItem("GregsLighting", "glowstoneBulb", 1L, 0), 'C',
                        new ItemStack(crazypants.enderio.EnderIO.itemPowerConduit, 1, 0)});
        // --- Light
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 1, 2),
                new Object[]{"QQQ", "PDP", "PCP", 'Q', new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 1, 0), 'P',
                        OrePrefixes.plate.get(Materials.Silicon), 'D',
        ...
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemExtractSpeedUpgrade, 1, 0),
                new Object[]{"POP", "GIG", "PWP", 'P', OrePrefixes.plate.get(Materials.ElectricalSteel),
                        'O', OrePrefixes.plate.get(Materials.Iron), 'G',
                        OrePrefixes.gearGtSmall.get(Materials.Iron), 'W',
                        OrePrefixes.wireGt01.get(Materials.RedAlloy), 'I', new ItemStack(Blocks.piston)});
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemExtractSpeedUpgrade, 2, 0),
                new Object[]{"POP", "GIG", "PWP", 'P', OrePrefixes.plate.get(Materials.ElectricalSteel),
                        'O', OrePrefixes.plate.get(Materials.WroughtIron), 'G',
                        OrePrefixes.gearGtSmall.get(Materials.WroughtIron), 'W',
                        OrePrefixes.wireGt01.get(Materials.RedAlloy), 'I', GT_ItemList.ULVPiston.get(1L)});
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemExtractSpeedUpgrade, 4, 0),
                new Object[]{"POP", "GIG", "PWP", 'P', OrePrefixes.plate.get(Materials.ElectricalSteel),
                        'O', OrePrefixes.plate.get(Materials.Steel), 'G',
                        OrePrefixes.gearGtSmall.get(Materials.Steel), 'W',
                        OrePrefixes.wireGt01.get(Materials.RedAlloy), 'I',
                        ItemList.Electric_Piston_LV.get(1L)});
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemExtractSpeedUpgrade, 8, 0),
                new Object[]{"POP", "GIG", "PWP", 'P', OrePrefixes.plate.get(Materials.ElectricalSteel),
                        'O', OrePrefixes.plate.get(Materials.Aluminium), 'G',
                        OrePrefixes.gearGtSmall.get(Materials.Aluminium), 'W',
                        OrePrefixes.wireGt01.get(Materials.RedAlloy), 'I',
                        ItemList.Electric_Piston_MV.get(1L)});
        GT_ModHandler.addCraftingRecipe(new ItemStack(crazypants.enderio.EnderIO.itemExtractSpeedUpgrade, 16, 0),
                new Object[]{"POP", "GIG", "PWP", 'P', OrePrefixes.plate.get(Materials.ElectricalSteel),
                        'O', OrePrefixes.plate.get(Materials.StainlessSteel), 'G',
                        OrePrefixes.gearGtSmall.get(Materials.StainlessSteel), 'W',
                        OrePrefixes.wireGt01.get(Materials.RedAlloy), 'I',
    ...
    public void assemblerRecipe() {
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Conveyor_Module_LV.get(1),
                        ...
                        new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 4, 1), GT_Utility.getIntegratedCircuit(1)}, null,
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Electric_Pump_LV.get(1),
                        ...
                        new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 4, 1), GT_Utility.getIntegratedCircuit(1)}, null,
                new ItemStack(crazypants.enderio.EnderIO.itemLiquidConduit, 4, 0), 120, 16);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Electric_Pump_MV.get(1),
                        GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.StainlessSteel, 4L),
                        new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 4, 1), GT_Utility.getIntegratedCircuit(1)}, null,
                new ItemStack(crazypants.enderio.EnderIO.itemLiquidConduit, 4, 1), 160, 48);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Electric_Pump_HV.get(1),
                        ...
                        new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 4, 1), GT_Utility.getIntegratedCircuit(1)}, null,
                new ItemStack(crazypants.enderio.EnderIO.itemLiquidConduit, 4, 2), 200, 120);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Electric_Pump_EV.get(1),
                        GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.TungstenSteel, 4L),
                        new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 16, 1), GT_Utility.getIntegratedCircuit(1)}, null,
                new ItemStack(crazypants.enderio.EnderIO.itemLiquidConduit, 16, 2), 300, 480);
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{ItemList.Electric_Pump_IV.get(1),
                        GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.NiobiumTitanium, 4L),
                        new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 64, 1), GT_Utility.getIntegratedCircuit(1)}, null,
                new ItemStack(crazypants.enderio.EnderIO.itemLiquidConduit, 64, 2), 400, 1920);
        // --- Item Filter
        GT_Values.RA.addAssemblerRecipe(ItemList.Conveyor_Module_LV.get(1),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 1L),
                new ItemStack(crazypants.enderio.EnderIO.itemBasicFilterUpgrade, 1, 0), 100, 16);
        // --- Advanced Item Filter
        GT_Values.RA.addAssemblerRecipe(ItemList.Conveyor_Module_MV.get(1),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.ElectricalSteel, 1L),
                new ItemStack(crazypants.enderio.EnderIO.itemBasicFilterUpgrade, 1, 1), 100, 64);
        // --- Big Item Filter
        GT_Values.RA.addAssemblerRecipe(ItemList.Conveyor_Module_HV.get(1),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.DarkSteel, 1L),
                new ItemStack(crazypants.enderio.EnderIO.itemBigFilterUpgrade, 1, 0), 200, 256);
        // --- Big Advanced Item Filter
        GT_Values.RA.addAssemblerRecipe(ItemList.Conveyor_Module_EV.get(1),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSLA, 1L),
                new ItemStack(crazypants.enderio.EnderIO.itemBigFilterUpgrade, 1, 1), 300, 480);
        // --- Mod Filter
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.itemBasicFilterUpgrade, 1, 0),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.DarkSteel, 1L),
                new ItemStack(crazypants.enderio.EnderIO.itemModItemFilter, 1, 0), 200, 120);
        // --- Chargeable Item Filter
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.itemConduitProbe, 1, 0),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.ElectricalSteel, 1L),
                new ItemStack(crazypants.enderio.EnderIO.itemPowerItemFilter, 1, 0), 200, 64);
        // --- Network Conduit (OC)
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem("OpenComputers", "cable", 1L),
                new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 1, 1), new ItemStack(crazypants.enderio.EnderIO.itemOCConduit, 1, 0), 120,
                16);
        // --- Capacitor
        GT_Values.RA.addAssemblerRecipe(ItemList.Battery_Hull_LV.get(1),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Plastic, 4L),
                Materials.Redstone.getMolten(576), new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 0), 200,
                30);
        // --- Capacitor 2
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 2, 0),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.EnergeticAlloy, 4L),
                Materials.Glowstone.getMolten(576), new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 1), 300,
                120);
        // --- Capacitor 3
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 2, 1),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.VibrantAlloy, 4L),
                Materials.ConductiveIron.getMolten(576), new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 2),
                400, 480);
        // --- Redstone Conduit
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.itemRedstoneConduit, 1, 2),
                new ItemStack(Blocks.lever, 1), new ItemStack(crazypants.enderio.EnderIO.itemRedstoneConduit, 1, 1), 50, 60);
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.itemRedstoneConduit, 1, 0),
                new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 1, 1), new ItemStack(crazypants.enderio.EnderIO.itemRedstoneConduit, 1, 2),
                50, 30);
        GT_Values.RA
                .addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.RedAlloy, 1L),
                        new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 1, 1),
                        new ItemStack(crazypants.enderio.EnderIO.itemRedstoneConduit, 1, 0), 50, 30);
        // --- Power Conduit
        GT_Values.RA
                .addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Copper, 1L),
                        new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 1, 1), Materials.ConductiveIron.getMolten(144),
                        new ItemStack(crazypants.enderio.EnderIO.itemPowerConduit, 1, 0), 50, 30);
        // --- ME Conduit
        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1, 16),
                new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 4, 1), new ItemStack(crazypants.enderio.EnderIO.itemMEConduit, 1, 0), 50,
                120);
        GT_Values.RA.addAssemblerRecipe(
                GT_ModHandler.getModItem("appliedenergistics2", "item.ItemMultiPart", 1, 76),
                new ItemStack(crazypants.enderio.EnderIO.itemMaterial, 4, 1), new ItemStack(crazypants.enderio.EnderIO.itemMEConduit, 1, 1), 100,
                480);
        // --- Speed Upgrade
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.itemExtractSpeedUpgrade, 1, 0),
                GT_Utility.getIntegratedCircuit(1), new ItemStack(crazypants.enderio.EnderIO.itemExtractSpeedUpgrade, 1, 1),
                50, 30);
        // --- Dark Pressure Plate
        GT_Values.RA
                .addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.DarkSteel, 2L),
                        ...
                        new ItemStack(crazypants.enderio.EnderIO.blockDarkSteelPressurePlate, 1, 0), 200, 16);
        // --- DarkIron Bars
        GT_Values.RA
                .addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.DarkSteel, 3L),
                        GT_Utility.getIntegratedCircuit(3), new ItemStack(crazypants.enderio.EnderIO.blockDarkIronBars, 4, 0), 400,
                        48);
        // --- Powered Light Inverted
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 1, 0),
                GT_ModHandler.getModItem("minecraft", "redstone_torch", 1L),
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 1, 1), 200, 64);
        // --- Light Inverted
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 1, 2),
                GT_ModHandler.getModItem("minecraft", "redstone_torch", 1L),
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 1, 3), 100, 16);
        // --- Wireless Powered Light
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 4, 0),
                ...
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 4, 4), 100, 120);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[]{new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 16, 0),
                ...
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 16, 4), 150, 480);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[]{new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 64, 0),
                ...
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 64, 4), 200, 1920);
        // --- Wireless Powered Light Inverted
        GT_Values.RA.addAssemblerRecipe(new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 1, 4),
                GT_ModHandler.getModItem("minecraft", "redstone_torch", 1L),
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 1, 5), 100, 64);
        // --- Light
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        ...
                        new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 4, 0)}, null,
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 16, 2), 200, 64);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Desh, 1L),
                        GT_ModHandler.getModItem("GalacticraftCore", "tile.arclamp", 1L),
                        new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 16, 0)}, null,
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 64, 2), 300, 256);
        // --- Powered Light
        GT_Values.RA.addAssemblerRecipe(new ItemStack[]{
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.ElectricalSteel, 1L),
                        GT_ModHandler.getModItem("GregsLighting", "ic2ElectricFloodlight", 1L),
                        new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 4, 0)}, null,
                new ItemStack(crazypants.enderio.EnderIO.blockElectricLight, 16, 0), 200, 64);
        GT_Values.RA.addAssemblerRecipe(
                new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Desh, 1L),
                        GT_ModHandler.getModItem("GregsLighting", "ic2ElectricFloodlight", 1L),
                        new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 16, 0)}, null,
    ...
    public void chemicalBathRecipe() {
        ...
        GT_Values.RA.addChemicalBathRecipe(new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 1, 1),
                Materials.Glowstone.getMolten(576L), new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 1, 3),
                GT_Values.NI, GT_Values.NI, null, 100, 4);
        GT_Values.RA
                .addChemicalBathRecipe(new ItemStack(Blocks.glass, 1), Materials.Chlorine.getGas(50L),
                        new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 1, 1), GT_Values.NI, GT_Values.NI, null, 400,
                        2);
    }
    ...
    public void printerRecipe() {
        ...
        GT_Values.RA.addPrimitiveLineRecipe(new ItemStack[]{
                ...
                new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 1, 2), ItemList.Field_Generator_MV.get(1L),
                ItemList.Sensor_HV.get(2L), new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 4, 0),
                GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.DarkSteel, 8)
        }, new ItemStack(crazypants.enderio.EnderIO.blockTelePad, 9, 0), null, 20 * 20, 480);
        // --- Transceiver
        GT_Values.RA.addBasicLineRecipe(new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Enderium, 1),
                ItemList.Field_Generator_LuV.get(1L), new ItemStack(crazypants.enderio.EnderIO.itemBasicCapacitor, 4, 2),
                GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4),
                new ItemStack(crazypants.enderio.EnderIO.blockFusedQuartz, 6, 0),
        ...
        }, new ItemStack(crazypants.enderio.EnderIO.blockTransceiver, 1, 0), null, 40 * 20, 30720);
    }
