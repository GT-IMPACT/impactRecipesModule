...
public class ImpactCore implements Runnable {
	...
	private void hand() {
		...
		GT_ModHandler.addCraftingRecipe(CoreItems2.getRecipe(HeavyDutyNoseConeTier7.getMetaID(), 1), tBitMask, new Object[]{"dNh", "SPS", "PAP", 'N', CoreItems2.getRecipe(HeavyDutyNoseConeTier6.getMetaID(), 1), 'S', OrePrefixes.screw.get(Materials.Infuscolium), 'P', CoreItems2.getRecipe(85, 1), 'A', CoreItems2.getRecipe(14, 1)});
		...
		GT_ModHandler.addCraftingRecipe(CoreItems2.getRecipe(HeavyDutyRocketEngineTier7.getMetaID(), 1), tBitMask, new Object[]{"PIP", "PSP", "BEB", 'I', OrePrefixes.pipeTiny.get(Materials.Infuscolium), 'S', ItemList.Electric_Piston_UHV, 'B', CoreItems2.getRecipe(39, 1), 'P', CoreItems2.getRecipe(14, 1), 'E', CoreItems2.getRecipe(28, 1)});
	...
	private void unboxing() {
		...
		RA.addUnboxingRecipe(
				...
				GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Inconel792, 1),
				ItemList.Energy_LapotronicOrb2.get(1L), 1800, 250
		);
		RA.addUnboxingRecipe(
...
//Controllers
		...
		RA.addBasicLineRecipe(new ItemStack[]{
						ItemList.Hull_LuV.get(1L),
						GT_ModHandler.getModItem(AE2, "tile.BlockAdvancedCraftingStorage", 1, 0),
						GT_ItemList.UpgradeCasingT1.get(1L),
						GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.HastelloyN, 16),
				...
				GT_ItemList.UpgradeCasingT2.get(1L), null,200 * 20, 2000000);
		//UpgradeCasingT3
		RA.addBasicLineRecipe(new ItemStack[]{
		...
		RA.addBasicLineRecipe(new ItemStack[]{
						ItemList.Hull_ZPM.get(1L),
						GT_ModHandler.getModItem(AE2, "tile.BlockAdvancedCraftingStorage", 1, 1),
						GT_ItemList.UpgradeCasingT2.get(1L),
						GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.Lafium, 16),
				...
				GT_ItemList.UpgradeCasingT3.get(1L), null,250 * 20, 8000000);
		//UpgradeCasingT4
		RA.addBasicLineRecipe(new ItemStack[]{
		...
		RA.addBasicLineRecipe(new ItemStack[]{
						ItemList.Hull_UV.get(1L),
						GT_ModHandler.getModItem(AE2, "tile.BlockAdvancedCraftingStorage", 1, 2),
						GT_ItemList.UpgradeCasingT3.get(1L),
						GT_OreDictUnificator.get(OrePrefixes.plateDouble, Materials.CinobiteA243, 16),
						...
						GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Nano, 8),
						GT_OreDictUnificator.get(OrePrefixes.wireGt04, Materials.SuperconductorUEV, 8),
						GT_OreDictUnificator.get(OrePrefixes.itemCasing, Materials.Osmium, 16),
						GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.HSSE, 64)
				},
				GT_ItemList.UpgradeCasingT4.get(1L), null,300 * 20, 32000000);
	...
	private void lathe() {
		...
		RA.addLatheRecipe(new ItemStack(Blocks.stone),
				GT_ModHandler.getModItem("ForgeMicroblock", "stoneRod", 2L), null, 100, 12);
	}
...
//Spatial Chip
	...
	private void centrifuge() {
		...
		RA.addCentrifugeRecipe(GregTech_API.getStackofAmountFromOreDict("dustIo", 1), GT_Values.NI,
				...
				new int[]{1200, 600, 300, 80, 50, 20}, 1000, 250
		);
	...
	private void alloySmelter() {
		...
		RA.addAlloySmelterRecipe(GT_ModHandler.getModItem("IC2", "itemPartIridium", 2L),
				ItemList.Shape_Mold_Casing.get(0), CoreItems2.getRecipe(52, 3), 1200, 250
		);
		RA.addAlloySmelterRecipe(new ItemStack(Items.clay_ball, 1, 0),
	...
	private void assembler() {
		...
		RA.addAssemblerRecipe(
				new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.slab, Materials.Wood, 6L),
						...
						GT_Utility.getIntegratedCircuit(2)}, null, GT_ItemList.SawCase.get(2L), 50, 12);
...
//Space parts
		RA.addAssemblerRecipe(
				...
				Materials.StainlessSteel.getMolten(72), CoreItems2.getRecipe(97, 1), 200, 250
		);
		RA.addAssemblerRecipe(
				...
				Materials.StainlessSteel.getMolten(288), ItemList.Ingot_Heavy1.get(1L), 200, 250
		);
		RA.addAssemblerRecipe(
		...
		RA.addAssemblerRecipe(
				...
				Materials.Titanium.getMolten(144), ItemList.Ingot_IridiumAlloy.get(1L), 200, 250
		);
		RA.addAssemblerRecipe(
		...
		RA.addAssemblerRecipe(new ItemStack[]{GT_ItemList.packMoon.get(64L)},
				Materials.BT6.getMolten(288), GT_ItemList.spacebox2.get(1L), 1200, 250
		);
		RA.addAssemblerRecipe(
...
//Casings
		...
		RA.addAssemblerRecipe(
				...
				CoreItems2.getRecipe(137, 1), 600, 250);
		...
		RA.addAssemblerRecipe(
				new ItemStack[]{ItemList.Hull_HV.get(1), ItemList.HV_Coil.get(1),
						...
						GT_Utility.getIntegratedCircuit(2)}, null,
				GT_ItemList.LDPE_HV.get(2L), 150, 250
		);
		RA.addAssemblerRecipe(
		...
		RA.addAssemblerRecipe(
				...
				new FluidStack(FluidRegistry.getFluid("ic2coolant"), 1000),
				CoreItems2.getRecipe(189, 1), 400, 250
		);
	...
	private void chemical() {
		...
		RA.addMultiblockChemicalRecipe(
				...
				new ItemStack[]{Materials.SiliconDioxide.getDust(1), CoreItems.getRecipe(49, 1)}, 300, 250
		);
	...
	private void ciruit() {
				...
				RA.addCircuitAssemblerRecipe(
						...
						CoreItems2.getRecipe(0, 1), 1000, 250
				);
				RA.addCircuitAssemblerRecipe(
	...
	public void drying() {
		// Graphene
		impact.I_RA.addDryingOvenRecipe(CoreItems2.getRecipe(193, 1), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Graphene, 1L)}, 800, 12);
	}
