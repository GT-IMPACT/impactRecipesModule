        ...
        TT_recipeAdder
                .addResearchableAssemblylineRecipe(ItemList.Casing_Fusion_Coil3.get(1L), 12000, 32, 500000,
                        6, new Object[]{
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Nano, 4L),
                                GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Bio, 8L),
                                GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Infinite, 16L),
                                GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Superconductor, 32L),
