...
public class Jabba implements Runnable {
    ...
    private void handRecipe() {
        ...
        GT_ModHandler.addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeCore, 1, 7), tBitMask,
                new Object[]{"STS", "PVP", "SRS", 'P', OrePrefixes.itemCasing.get(Materials.Steel), 'S',
                        ...
                        'T', new ItemStack(BetterBarrels.itemUpgradeCore, 1, 0)});
        // --- Barrel Hammer
        GT_ModHandler.addCraftingRecipe(new ItemStack(BetterBarrels.itemHammer, 1, 0), tBitMask,
                new Object[]{"IPI", "STS", "hTd", 'I', OrePrefixes.ingot.get(Materials.Iron), 'P',
                        OrePrefixes.plate.get(Materials.Iron), 'S', OrePrefixes.screw.get(Materials.Iron), 'T',
                        OrePrefixes.stick.get(Materials.Iron)});
        // --- Dolly
        GT_ModHandler.addCraftingRecipe(new ItemStack(BetterBarrels.itemMover, 1, 0), tBitMask,
                new Object[]{"TTR", "TwR", "OPO", 'R', OrePrefixes.round.get(Materials.Rubber), 'P',
                        OrePrefixes.plate.get(Materials.Steel), 'T', OrePrefixes.stick.get(Materials.Iron), 'O',
                        ItemList.Component_Minecart_Wheels_Iron});
        // --- Storage Upgrade
        GT_ModHandler.addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeCore, 1, 0), tBitMask,
                new Object[]{"SPS", "SDS", " d ", 'S', OrePrefixes.screw.get(Materials.Steel), 'P',
                        new ItemStack(Blocks.piston), 'D', new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK I
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 0), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Wood), 'P',
                                OrePrefixes.plate.get(Materials.Wood), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK II
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 1), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Bronze), 'P',
                                OrePrefixes.plate.get(Materials.Bronze), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK III
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 2), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.WroughtIron),
                                'P', OrePrefixes.plate.get(Materials.WroughtIron), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK IV
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 3), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Cobalt), 'P',
                                OrePrefixes.plate.get(Materials.Cobalt), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK V
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 4), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Steel), 'P',
                                OrePrefixes.plate.get(Materials.Steel), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK VI
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 5), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Obsidian), 'P',
                                OrePrefixes.plate.get(Materials.Obsidian), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK VII
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 6), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Diamond), 'P',
                                OrePrefixes.plate.get(Materials.Diamond), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK VIII
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 7), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Aluminium), 'P',
                                OrePrefixes.plate.get(Materials.Aluminium), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK IX
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 8), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Titanium), 'P',
                                OrePrefixes.plate.get(Materials.Titanium), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK X
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 9), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.TungstenSteel),
                                'P', OrePrefixes.plate.get(Materials.TungstenSteel), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Structural Upgrade MK XI
        GT_ModHandler
                .addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeStructural, 1, 10), tBitMask,
                        new Object[]{"SPS", "PDP", "SPS", 'S', OrePrefixes.stick.get(Materials.Iridium), 'P',
                                OrePrefixes.plate.get(Materials.Iridium), 'D',
                                new ItemStack(BetterBarrels.blockBarrel, 1, 0)});
        // --- Redstone Upgrade
        GT_ModHandler.addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeCore, 1, 2), tBitMask,
                new Object[]{"PTP", "TBT", "PTP", 'P', OrePrefixes.plate.get(Materials.RedAlloy), 'B',
                        OrePrefixes.block.get(Materials.Redstone), 'T', new ItemStack(Blocks.piston)});
        // --- Hopper Upgrade
        GT_ModHandler.addCraftingRecipe(new ItemStack(BetterBarrels.itemUpgradeCore, 1, 3), tBitMask,
                new Object[]{"PTP", "TBT", "PTP", 'P', OrePrefixes.plate.get(Materials.Iron), 'B',
    ...
    private void assemblerRecipe() {
        ...
        GT_Values.RA.addAssemblerRecipe(
                ...
                Materials.Redstone.getMolten(144), new ItemStack(BetterBarrels.itemUpgradeCore, 1, 7), 400,
                30);
    }
